...
export function RenderNewsThree({item}: any) {
    return (
        <>
                ...
                <Box p={"0"} display={"flex"} justifyContent={"center"} mb={"1rem"}>
                    ...
                    >
                        <CardHeader>
                            ...
                            <Box>
                                <Text fontSize={"1rem"} textAlign={"left"}>{item?.newsUs?.description}</Text>
                            </Box>
                        </CardHeader>

                        <CardBody p={"0"}>
                            <Img src={item?.newsUs?.urlToImage} h={"100%"} w={"100%"} objectFit={"cover"} />
                        </CardBody>
